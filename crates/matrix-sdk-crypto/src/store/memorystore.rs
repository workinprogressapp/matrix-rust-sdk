...
use ruma::{
    serde::Raw, DeviceId, OwnedDeviceId, OwnedRoomId, OwnedTransactionId, OwnedUserId, RoomId,
...
pub struct MemoryStore {
    ...
    direct_withheld_info: Arc<DashMap<OwnedRoomId, DashMap<String, Raw<RoomKeyWithheldEvent>>>>,
}
...
impl CryptoStore for MemoryStore {
    ...
    async fn get_withheld_info(
        ...
        room_id: &RoomId,
        session_id: &str,
    ) -> Result<Option<Raw<RoomKeyWithheldEvent>>> {
        Ok(self
